...
ablaufzeileBenedictusGounodDVE = {
  \globalBenedictusGounodDVE
  s1*26
  \tempo "Andante"
}
...
sopranNotenBenedictusGounodDVE = \tempTranspose \relative c'' {
  ...
  a4..^\p a16 g4 r8 g \mBreak | \barNumberCheck #(- 220 taktkorrektur-benedictus-gounoddve)
  g2 a4 a | % 221
  a4.. a16 bes4 r4 | % 222
...
altNotenBenedictusGounodDVE = \tempTranspose \relative c' {
  ...
  f4..^\p f16 e4 r8 e \mBreak | \barNumberCheck #(- 220 taktkorrektur-benedictus-gounoddve)
  e2 fis4 fis | % 221
